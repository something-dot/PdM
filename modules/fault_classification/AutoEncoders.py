...
def hyper_param_tune(df, activation_list, optimizer_list, learn_rate_list, path):
    ...
    for k in learn_rate_list:
        for j in optimizer_list:
            for i in activation_list:
                ...
                autoencoder = auto_encoder_model(input_dim=input_dim, nb_epoch=200, batch_size=128, encoding_dim=32,
    ...
    auto_encoder = auto_encoder_model(input_dim=train_test_valid_standardised_data[0].shape[1], nb_epoch=1000,
                                      batch_size=32, encoding_dim=200, learning_rate=results[2],
...
if __name__ == '__main__':
    ...
    best_model = hyper_param_tune(df, activation_list, optimizer_list, learn_rate_list)
